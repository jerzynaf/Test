...
export class UserListItemView extends refBaseView.BaseItemView<refItemModel.UserListItemModel> {
    constructor(options?: any) {
        if (!options) options = {};

        options.template = super.loadTemplate("MaintainUsersApp/userListItem");
        options.events = {
